...
if __name__ == '__main__': #Requered for parallization, at least on Windows
    ...
    for conttype in [conttype]:
        ...
        [contacts_files.append(input_folder+ "chr"+chr+".5KB.NPC."+params.conttype) for chr in chr_nums]
        params.contacts_reader.read_files(contacts_files, coeff_fname="coefficient."+cell_type+".5000.txt", max_cpus=params.max_cpus,
                                          fill_empty_contacts=fill_empty_contacts, maxdist=params.maxdist)

        if params.use_only_contacts_with_CTCF == "cont_with_CTCF":
            params.proportion = 1
            params.contacts_reader.use_contacts_with_CTCF(CTCFfile=input_folder + "CTCF/GSE96107_NPC_CTCF.IDR0.05.filt.narrowPeak.gz",
                                                          maxdist=params.maxdist, proportion=params.proportion, keep_only_orient=params.keep_only_orient,
                                                          CTCForientfile=input_folder + "CTCF/GSE96107_NPC_CTCF.IDR0.05.filt.narrowPeak-orient.bed")
        ...
        params.ctcf_reader = ChiPSeqReader(input_folder + "CTCF/GSE96107_NPC_CTCF.IDR0.05.filt.narrowPeak.gz",
                                                            name="CTCF")
        params.ctcf_reader.read_file()
        params.ctcf_reader.set_sites_orientation(
            input_folder + "CTCF/GSE96107_NPC_CTCF.IDR0.05.filt.narrowPeak-orient.bed")
        ...
        params.ctcf_reader_orientOnly = ChiPSeqReader(input_folder + "CTCF/GSE96107_NPC_CTCF.IDR0.05.filt.narrowPeak.gz",
                                                            name="CTCF")
        ...
        params.pgs = [OrientCtcfpg, NotOrientCTCFpg, OrientBlocksCTCFpg ,RNAseqPG, ConvergentPairPG]#+chipPG#+cagePG+metPG+chipPG
        #
        # Generate train
        train_chrs=[]
