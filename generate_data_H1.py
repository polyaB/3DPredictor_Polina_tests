...
if __name__ == '__main__': #Requered for parallization, at least on Windows
    ...
    for conttype in [conttype]:
        ...
        input_folder ="/mnt/scratch/ws/psbelokopytova/202001051010polina_data/3DPredictor/input/H1/"
        ...
        params.contacts_reader.read_files(contacts_files,
                                          ...
                                          fill_empty_contacts=fill_empty_contacts, maxdist=params.maxdist, expected_binsize=params.window_size)
        ...
        print(params.contacts_reader.data["chr14"].keys())
        #Loops predictor
